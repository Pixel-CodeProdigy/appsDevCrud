  ...
  <div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
      <div class="flex justify-between items-center gap-4">
        <h1 class="text-3xl font-bold text-red-500">Student List</h1>
        <router-link :to="{ name: 'add' }">
          <button class="bg-green-200 rounded p-3 mr-3 w-40">
            Add Student
          </button>
        </router-link>
      </div>
              ...
              <tbody velse-if="studentData && studentData.student">
                <tr v-for="(stu, i) in studentData.student" :key="stu.id">
                  ...
                  >
                    ...
                    <button
                      class="bg-green-200 rounded p-3 inline-block mr-3 w-20"
                      @click="deleteStudent(stu.id)"
                    >
                      Delete
                    </button>
                  </td>
